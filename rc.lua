...
--------------------------------------------------------------------------------------------------------
--batteryarc-widget(awesome-wm-widgets)
local batteryarc_widget = require("awesome-wm-widgets.batteryarc-widget.batteryarc")

--battery-widget(awesome-wm-widgets)
local battery_widget = require("awesome-wm-widgets.battery-widget.battery")

--brightness-widget(awesome-wm-widgets)
...
beautiful.border_focus = "#0DE5F8"
beautiful.border_normal = "#033E43"
...
---wireless-network
net_wireless = net_widgets.wireless({timeout = 1 ,interface = "wlp1s0"})
...
---------------------------------------------------
-- Create a custom tasklist template to show only icons
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ " D ", " O ", " N "," -   D ", " A "," D "," A ", }, s, awful.layout.layouts[1])
   ...
   -- Then, create a separator widget
--=local separator = wibox.widget.separator
    ...
    local space = wibox.widget {
        ...
        text   = "  ", -- Two spaces for separation
        align  = "center",
        valign = "center",
    }
        ----wide spaces
    local wspace = wibox.widget {
        widget = wibox.widget.textbox,
        text   = "                                                                         ", -- wide spaces for separation
        align  = "center",
        valign = "center",
    }
...
globalkeys = gears.table.join(
    ...
    ---Application Keybindings          
        -- Brave
            ...
            { description = "Open Brave", group = "Applications" }),

    -- files
            awful.key({ modkey, 'Shift' }, "f", function () awful.util.spawn("nautilus") end,
            {description = "Open Files", group = "Applications"}),
    ...
    -- Vscode
            ...
            { description = "Open Visual Studio Code", group = "Applications" }),

    -- Copyq
            awful.key({ modkey }, "z", function () awful.spawn("copyq toggle") end,
            { description = "Open CopyQ", group = "Applications" }),
    ...
    -- Blueman 
            ...
            { description = "Open Blueman", group = "Applications" }),
...
client.connect_signal("manage", function (c)
    ...
    --[[--  Round corners of appalication windows--]]
...
--[-- round corners of notificatiions--]--
